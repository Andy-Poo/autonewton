...
class Wikipedia:
    ...
    #url_article = 'http://%s.wikipedia.org/w/index.php?action=query&list=search&search=%s'
    #url_article = 'http://%s.wikipedia.org/w/index.php?action=query&list=json&search=%s'
    url_article = 'https://%s.wikipedia.org/w/api.php?format=json&action=query&list=search&srsearch=%s'
    ...
    def article(self, article):
        ...
        if content.upper().startswith('#REDIRECT'):
            ...
            raise WikipediaError('Cannot find redirect article.')
