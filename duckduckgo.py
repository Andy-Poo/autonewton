...
def query(query, useragent='python-duckduckgo '+str(__version__), safesearch=True, html=True, meanings=True, **kwargs):
    """
    ...
    encparams = urllib.urlencode(query_args)
    encparams += '&' + urllib.urlencode(params)
    url = 'http://api.duckduckgo.com/?' + encparams
    if debug: print 'duckduckgo::query: url=', url
